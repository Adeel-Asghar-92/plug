...
// Admin routes
router.post('/', isAdmin, upload.single('image'), teamMemberController.createTeamMember);
router.put('/:id', isAdmin, upload.single('image'), teamMemberController.updateTeamMember);
router.delete('/:id', isAdmin, teamMemberController.deleteTeamMember);
